...
ALTER TABLE GeoFenceRegions ADD color TEXT;
...
HouseNumber,title,latitude,longitude, _geoFenceRegionId,outerMinLat,outerMinLon,outerMaxLat,outerMaxLon,color,rectangleId,
